...
public class ChartControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        // Khởi tạo DAO để lấy dữ liệu sản phẩm bán chạy
        ChartDAO dao = new ChartDAO();
        List<BestSellingProduct> bestSellers = dao.getBestSellingProducts();

        // Đặt dữ liệu sản phẩm bán chạy vào request để hiển thị trên JSP
        request.setAttribute("bestSellers", bestSellers);
        
        // Chuyển hướng đến trang JSP để hiển thị biểu đồ

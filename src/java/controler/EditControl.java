...
//        processRequest(request, response);
        ...
        String discontinued = request.getParameter("discontinued") != null ? "true" : "false";
        String status = request.getParameter("status");

        ProductDAO dao = new ProductDAO();
        int result = dao.editProduct(name, image, price, stock, sold, volume, color, supplier, description, category, discontinued, status, pid);

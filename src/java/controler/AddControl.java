...
public class AddControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.productExisted(name)) {
                request.getSession().setAttribute("message", "Product name already exists!");
            ...
            request.getSession().setAttribute("message", "Invalid numeric input!");
            response.sendRedirect("manager");
        }
    }
}
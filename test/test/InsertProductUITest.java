...
public class InsertProductUITest {
    ...
    private String generateRandomProductName() {
        ...
        StringBuilder sb = new StringBuilder("Sơn Test ");
        for (int i = 0; i < 5; i++) {
    ...
    private String productName = generateRandomProductName();
    ...
    public void testInsertProductSuccess() throws InterruptedException {
        ...
        // fill
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("name"))).sendKeys(productName);
